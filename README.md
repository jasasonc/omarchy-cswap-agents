...
After the first `s`, the switch command waits 3 seconds for the second `s`. If you change the tab or close the panel, the switch command stops. With a mouse, click the switch button two times.
